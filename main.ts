namespace SpriteKind {
    export const Firespark = SpriteKind.create()
...
function level4 () {
    ...
    tiles.placeOnTile(mySprite, tiles.getTileLocation(24, 29))
}
...
function level6 () {
    ...
    tiles.placeOnTile(mySprite, tiles.getTileLocation(5, 32))
    currentlevel = 6
}
...
function level5 () {
    ...
    tiles.placeOnTile(mySprite, tiles.getTileLocation(5, 33))
    currentlevel = 5
    boss6()
}
function level3 () {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.boss5, function (sprite, otherSprite) {
    if (mySprite.vy > 0 && mySprite.y < boss5.y) {
        mySprite.vy = -70
        boss5health += -2
    } else {
        info.changeLifeBy(-1)
...
function boss6 () {
    boss5 = sprites.create(img`
        ...
        . . f f f c c b d d d f . . . . 
        `, SpriteKind.boss5)
    boss5.setScale(2, ScaleAnchor.Middle)
    tiles.placeOnTile(boss5, tiles.getTileLocation(25, 29))
    boss5.ay = 300
    Boss5alive = true
    boss5health = 10
}
...
game.onUpdate(function () {
    if (currentlevel > 5) {
        sprites.destroy(boss5)
    }
})
game.onUpdate(function () {
    if (boss5health <= 0) {
        sprites.destroy(boss5, effects.halo, 500)
        Boss5alive = false
    }
})
game.onUpdate(function () {
